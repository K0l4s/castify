...
//    private GoogleIdTokenVerifier verifier;
    ...
    public RegisterResponse register(RegisterRequest request) throws Exception {
        ...
        var user = UserCollection.builder()
...
//        UserCollection user = verifyIDToken(requestBody.getTokenId());
//
//        if (user == null) {
...
//    }
    ...
    @Transactional
    public UserCollection createOauth2User(UserCollection user) {
        UserCollection existingAccount = userRepository.findByEmail(user.getEmail()).orElse(null);
    ...
    private void saveUserToken(UserCollection userEntity, String jwtToken) {
        var token = TokenCollection.builder()
    ...
    private void revokeAllUserTokens(UserCollection userEntity) {
...
//    private UserCollection verifyIDToken(String idToken) {
//        try {

...
const CreateFrameEventForm: React.FC<ModalProps> = ({
  ...
  return (
    <CustomModal title="Tạo Sự Kiện Mới" onClose={onClose} isOpen={isOpen} size="md">
      ...
      <form onSubmit={handleSubmit} className="space-y-4 p-4 rounded-lg relative">
        ...
        <div>
          ...
          <input
            ...
            className="w-full border border-gray-300 p-1.5 rounded text-sm focus:outline-none focus:ring-2 focus:ring-blue-400"
            required
        ...
        <div>
          ...
          <input
            ...
            className="w-full border border-gray-300 p-1.5 rounded text-sm bg-white dark:bg-gray-800 file:bg-white file:dark:bg-gray-700 file:text-black file:dark:text-white"
            disabled={isSubmitting}
          />
          {images.length > 0 && (
        ...
        <div className="flex justify-end gap-2 mt-2">
          <button
            type="button"
            onClick={onClose}
            className="px-3 py-1.5 rounded border border-gray-300 text-sm hover:bg-gray-100 transition"
            disabled={isSubmitting}
          >
            Hủy
          </button>

      ...
      >
        <div className="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
          <ul className="space-y-1 px-2 flex-1">
            <li>
              <Link to="/" className={getLinkClass("/")}>
                <svg
                  ...
                  fill="currentColor"
                  className={`w-[18px] h-[18px] ${isOpenSideBar ? 'mr-4' : 'mx-auto'}`}
                  viewBox="0 0 24 24"
                >
            ...
            <li>
              <Link to="/feed/follow" className={getLinkClass("/feed/follow")}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="currentColor"
                  className={`w-[18px] h-[18px] ${isOpenSideBar ? 'mr-4' : 'mx-auto'}`}
                ...
                {isOpenSideBar && <span>Follow</span>}
              </Link>
            </li>

            <li>
              <Link to="/feed/trend" className={getLinkClass("/feed/trend")}>
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className={`w-[18px] h-[18px] ${isOpenSideBar ? 'mr-4' : 'mx-auto'}`}
                  viewBox="0 0 24 24">
                  <path d="M16 6l2.29 2.29-4.88 4.88-4-4L2 16.59 3.41 18l6-6 4 4 6.3-6.29L22 12V6z" />
                </svg>
                {isOpenSideBar && <span>Trending</span>}
              </Link>
            </li>
            ...
            <li>
              <Link to="/feed/history" className={getLinkClass("/feed/history")}>
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className={`w-[18px] h-[18px] ${isOpenSideBar ? 'mr-4' : 'mx-auto'}`} viewBox="0 0 24 24">
                  <path d="M13 3c-4.97 0-9 4.03-9 9H1l3.89 3.89.07.14L9 12H6c0-3.87 3.13-7 7-7s7 3.13 7 7-3.13 7-7 7c-1.93 0-3.68-.79-4.94-2.06l-1.42 1.42C8.27 19.99 10.51 21 13 21c4.97 0 9-4.03 9-9s-4.03-9-9-9zm-1 5v5l4.28 2.54.72-1.21-3.5-2.08V8H12z" />
                </svg>
                {isOpenSideBar && <span>History</span>}
              </Link>
            </li>

            <li>
              <Link to="/reactions" className={getLinkClass("/reactions")}>
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className={`w-[18px] h-[18px] ${isOpenSideBar ? 'mr-4' : 'mx-auto'}`} viewBox="0 0 24 24">
                  <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z" />
                </svg>
                {isOpenSideBar && <span>Reactions</span>}
              </Link>
            </li>
